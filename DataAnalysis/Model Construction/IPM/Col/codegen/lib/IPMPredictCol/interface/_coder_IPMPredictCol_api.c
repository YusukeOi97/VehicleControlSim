...
void IPMPredictCol_atexit(void)
{
  ...
  IPMPredictCol_xil_terminate();
  IPMPredictCol_xil_shutdown();
...
/* End of code generation (_coder_IPMPredictCol_api.c) */
