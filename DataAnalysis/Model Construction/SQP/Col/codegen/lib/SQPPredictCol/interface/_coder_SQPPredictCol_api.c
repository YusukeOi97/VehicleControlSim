...
void SQPPredictCol_atexit(void)
{
  ...
  SQPPredictCol_xil_terminate();
  SQPPredictCol_xil_shutdown();
...
/* End of code generation (_coder_SQPPredictCol_api.c) */
