...
void PPPredictCol_atexit(void)
{
  ...
  PPPredictCol_xil_terminate();
  PPPredictCol_xil_shutdown();
...
/* End of code generation (_coder_PPPredictCol_api.c) */
