...
void IPMPredictCal_atexit(void)
{
  ...
  IPMPredictCal_xil_terminate();
  IPMPredictCal_xil_shutdown();
...
/* End of code generation (_coder_IPMPredictCal_api.c) */
