 ...
 *
 * _coder_roughDWAPredictCol_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "roughDWAPredictCol",                                 /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void roughDWAPredictCol_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  roughDWAPredictCol(*X, *Y_data, Y_size);
...
void roughDWAPredictCol_atexit(void)
{
  ...
  roughDWAPredictCol_xil_terminate();
  roughDWAPredictCol_xil_shutdown();
...
/* End of code generation (_coder_roughDWAPredictCol_api.c) */
