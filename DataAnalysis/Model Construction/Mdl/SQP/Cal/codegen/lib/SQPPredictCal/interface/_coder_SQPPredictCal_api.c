...
void SQPPredictCal_atexit(void)
{
  ...
  SQPPredictCal_xil_terminate();
  SQPPredictCal_xil_shutdown();
...
/* End of code generation (_coder_SQPPredictCal_api.c) */
