...
Kappa_array = 1; %ì¸óÕÇÃã»ó¶ -> ånóÒ or ñ êœ
...
Mdl = fitrnet(InputData, OutputData, "Standardize", true, "Lambda", 1e-4, "LayerSizes", [60 60 60 60 60])
...
figure(1);
histogram2(OutputPredicted(:, 1), OutputValidation(:, 1), [30 30], 'DisplayStyle', 'tile', 'ShowEmptyBins', 'On', 'XBinLimits', [0 1], 'YBinLimits', [0 1]);
axis equal
colorbar
ax = gca;
ax.CLim = [0 80];
