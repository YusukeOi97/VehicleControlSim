 ...
 *
 * _coder_roughDWAPredictCal_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "roughDWAPredictCal",                                 /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void roughDWAPredictCal_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  roughDWAPredictCal(*X, *Y_data, Y_size);
...
void roughDWAPredictCal_atexit(void)
{
  ...
  roughDWAPredictCal_xil_terminate();
  roughDWAPredictCal_xil_shutdown();
...
/* End of code generation (_coder_roughDWAPredictCal_api.c) */
