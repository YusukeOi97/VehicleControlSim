...
void PPPredictCal_atexit(void)
{
  ...
  PPPredictCal_xil_terminate();
  PPPredictCal_xil_shutdown();
...
/* End of code generation (_coder_PPPredictCal_api.c) */
