...
Method = 'SQP';
Data_path = strcat('C:\Data\MPC\', Method, '\');
OutData_path = 'C:\Data\MPC\';
...
%     ParaData = csvread(strcat(Data_path, string(Folderlist(1, i)), '\parameter.csv'), 1, 0);
...
%     csvwrite(strcat(OutData_path, Method, 'cleaned\', OutFolderlist, '\parameter.csv'), ParaData);
% end
